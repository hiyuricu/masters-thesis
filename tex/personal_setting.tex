...
そこで本研究では英単語タイピングゲームを利用することで，スペリング誤りに対応する単語が明らかであり，クラウドソーシングのコストもかからないスペリング誤りの抽出手法を提案し，実際に抽出したスペリング誤りに関する分析を行う．本研究の目的はスペリング誤り訂正に貢献することである.
またスペリング誤り抽出のためにタイピングゲームを利用することで起きる結果を仮定し，仮説が正しいことを示す．
}
...
Therefore, I propose to extract spelling errors by using an English word typing game. This game allows us to know the word corresponding to the spelling error and saves the cost of crowdsourcing. I analyze actual spelling errors extracted from the game. The purpose of this study is contribution to English spelling error correction.
I assume results caused by using English word typing game for English spelling error extraction, I show that the hypothesis is correct.
}